...
#[derive(Debug)]
pub struct ApacheVhostProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApacheVhostProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApacheVhost processing");
    
    let mut processor = ApacheVhostProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApacheVhostProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApacheVhostProcessor::new(false);
